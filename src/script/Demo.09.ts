...
export class Demo extends BaseDemo {
  ...
  public createGradient() {
    ...
    const gradient3 = context.createLinearGradient(0, this.centerY, this.centerX, canvas.height);
    ...
    const gradient4 = context.createLinearGradient(this.centerX, canvas.height, canvas.width, this.centerY);
